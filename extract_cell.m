function [b, i, d, ton, toff, maxl_a] = extract_cell(expression, time, frames_base, frames_on, frames_off, frames_tail, x0, plotting, extract_ON, base_for_OFF)
%this function extracts parameters of induction based on the expansion of
%model response into second order Taylor series

output = run_fits(expression, time, frames_on, frames_base, frames_off, frames_tail, x0, plotting, extract_ON, base_for_OFF);
